...
* Go
	>```go
	>go get github.com/codemodify/systemkit-service-spec
	>~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~ ~~~~
	>func main() {
...
* Terminal
	>```sh
	>systemkit-service-spec-cli create -name test-service -executable vim
	>systemkit-service-spec-cli delete -name test-service
	>systemkit-service-spec-cli start -name test-service
	>systemkit-service-spec-cli stop -name test-service
	>systemkit-service-spec-cli info -name test-service
	>```
